...
- Мокап запуска большой фичи (Plan Run): `design/plan-run-launch-v2.html`
  — кликабельный лаунчер на реальном layout доски (кнопка «⚡ Прогон» → мастер
  цель→этапы→сводный гейт → plan-rail с DAG над колонками).
